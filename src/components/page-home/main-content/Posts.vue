  ...
  <v-card rounded outlined>
    ...
    <v-list-item>
      ...
      <v-list-item-content>
        ...
        <v-list-item-subtitle
          class="questrial body1 font-weight-medium grey--text text--darken-1 my-2"
          >Thanks for sharing this. It makes my day.</v-list-item-subtitle
        >
        <v-layout>
          <v-flex xs4>
            <v-layout row>
